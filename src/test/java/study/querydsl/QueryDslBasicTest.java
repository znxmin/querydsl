...
public class QueryDslBasicTest {
    ...
    void findDtoBySetter() {
        // 프로퍼티 접근 (Setter) - MemberDto 기본생성자, setter 필요
    ...
    @Test
    void findDtoByField() {
        // 필드 직접 접근 - 생성자, getter, setter 필요 X
        List<MemberDto> result = queryFactory
    ...
    void findUserDtoByField() {
        // 별칭이 다를 때 (DTO에 정의된 필드명과 Entity의 필드명이 다를 때)
        // 필드 직접 접근 - 생성자, getter, setter 필요 X
        QMember memberSub = new QMember("memberSub");
    ...
    void findDtoByConstructor() {
        // 생성자 사용 - 파라미터 있는 생성자만 필요 / 기본생성자, getter, setter 필요 X
        List<MemberDto> result = queryFactory
    ...
    void findDtoByQueryProjection() {
        // DTO 생성자에 @QueryProjection 어노테이션 추가 후 gradle > compileQuerydsl
        // 컴파일러가 타입 체크해줄 수 있지만, DTO까지 Q파일 생성 필요
        List<MemberDto> result = queryFactory
